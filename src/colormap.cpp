#include "colormap.h"
 ...
 const float ColorMap::MATRIX[][3]={
     { 0.2158, 0.7060, 0.7513},
     { 0.9058, 0.0318, 0.2551},
     { 0.1270, 0.2769, 0.5060},
     { 0.9134, 0.0462, 0.6991},
     { 0.6324, 0.0971, 0.8909},
     { 0.0975, 0.8235, 0.9593},
     { 0.2785, 0.6948, 0.5472},
     { 0.5469, 0.3171, 0.1386},
     { 0.9575, 0.9502, 0.1493},
...
const float * ColorMap::getColor(int i){


        const float * p=&MATRIX[ std::labs(i)%MAX_VALUE ][0];
        return p;
